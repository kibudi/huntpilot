  ...
  return (
    <div className="flex flex-wrap items-center gap-2.5 py-4">
      ...
      <button
        type="button"
        onClick={onAdd}
        className="ml-auto flex items-center gap-1.5 rounded-[7px] bg-accent px-3.5 py-2 text-[13px] font-semibold text-on-accent transition-colors hover:bg-accent-bright"
      >
        <svg
          width="15"
          height="15"
